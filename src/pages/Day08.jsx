...
function Day08() {
    ...
    useEffect(() => {
        if (inputContent !== ""){
            try {
                let result = wasm.day08_part1(inputContent);
            ...
            try {
                let result = wasm.day08_part2(inputContent);
                console.log("Result", result);
                setPart2Ans(result)
            } catch (error) {
                console.log("Error", error);
        ...
        <>
            <div id={'day08'}>
                ...
                <div>
                    ...
                    {' '}   
                    <a href='https://github.com/AllaVinner/aoc-2023/blob/main/wasm-src/src/days/day08.rs'>solution</a>
                </div>
                <div>Hello</div>
            </div>
        </>
