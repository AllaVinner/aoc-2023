...
function Day06() {
    ...
    useEffect(() => {
        if (inputContent !== ""){
            try {
                let result = wasm.day06_part1(inputContent);
            ...
            try {
                let result = wasm.day06_part2(inputContent);
                console.log("Result", result);
                setPart2Ans(result)
            } catch (error) {
                console.log("Error", error);
        ...
        <>
            <div id={'day06'}>
                ...
                <div>
                    ...
                    {' '}   
                    <a href='https://github.com/AllaVinner/aoc-2023/blob/main/wasm-src/src/days/day06.rs'>solution</a>
                </div>
                <div>Hello</div>
            </div>
        </>
